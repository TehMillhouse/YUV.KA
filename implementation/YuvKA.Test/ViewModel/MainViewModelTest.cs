...
namespace YuvKA.Test.ViewModel
{
	public class MainViewModelTest
	{
		...
		{
			Assert.Equal(1, vm.ToolboxViewModel.NodeTypes.Single(asm => asm.Key.Item2 == typeof(BlurNode).Assembly).Value.Single(nodeTypeType => nodeTypeType.Key == "Manipulation").Value.Count(n => n.Type == typeof(YuvKA.Pipeline.Implementation.BlurNode)));
		}
