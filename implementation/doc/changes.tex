...
komplett geändert wurden. Dies lag auch teilweise daran, dass Frameworks verwendet wurden (z.B. im DiagramViewModel zum Zeichnen der Diagramme), die erst in der Implementierung ausgewählt wurden, sodass die Klassen entsprechend angepasst wurden mussten.