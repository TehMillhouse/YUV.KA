...
Die Klasse \name{YuvEncoder} bietet die Funktionalität, Videos, die im YUV-Format eingegeben werden, ins RGB-Format umzuwandeln, damit das Programm damit arbeiten kann. Desweiteren wandelt sie die manipulierten Videos vom RGB-Format ins YUV-Format um, damit sie abgespeichert werden können.
...
\paragraph{Beschreibung}~\\
Die Klasse \name{Video} bietet die Funktionalität, dass sie die vom \name{YuvEncoder} umgewandelte Videos als Videostream hält.
