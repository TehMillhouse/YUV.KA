...
\property{Tick}
	...
	\end{verbatim}
	Ruft den Index des zuletzt berechneten Ticks ab oder legt ihn fest. Das Neusetzen führt nicht zum erneuten Berechnen der im Tick berechneten \name{Frame}s, sondern muss mit \name{Start} explizit angefordert werden. Ein Tick repräsentiert hierbei den Zeitaschnitt für die Berechnung aller relevanten \name{Frame}s mit dem gegebenen Index.
