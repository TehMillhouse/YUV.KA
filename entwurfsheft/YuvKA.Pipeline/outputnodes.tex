...
\property{Graphs}
	...
	\end{verbatim}
	Stellt eine Liste der Diagrammtypen, für die Analysedaten bereitgestellt werden sollen, zur Verfügung. Ein Diagrammtyp wird von den folgenden drei Eigenschaften charakterisiert:
	...
	\paragraph{Art der Analyse}~\\ Es werden drei Arten von Bildanalysen unterstützt: 
		\begin{itemize}
			...
			\item \name{IntraBlockFrequency}
			\item \name{PeakSignalNoiseRatio} 
		\end{itemize}
\end{itemize}
