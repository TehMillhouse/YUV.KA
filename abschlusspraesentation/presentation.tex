...
\begin{frame}
	...
	\begin{center}
		\vspace*{\fill}
		\includegraphics[scale=.2]{video-encoding-process2.png}
		\vspace*{\fill}
		\onslide<2-> Warum das Ganze? ~\\
		\onslide<3-> $ \Longrightarrow $ Datenrate der Videos verbessern
	\end{center}
\end{frame}
...
\begin{frame}
	...
	\begin{minipage}{5.3cm}
		...
		\end{itemize}
		\onslide<5->{ $ \Longrightarrow $ Extrem aufwändig}
	\end{minipage}
	\hfill	
	% Beliebiger Encoder
	\begin{minipage}{5.3cm}
...
\begin{frame}
	...
	\begin{minipage}{5cm}
		\begin{center}
			Bild mit Motion-Vektoren ~\\
			\includegraphics[scale=.46]{football-motionvectors.png}		
		\end{center}	
	\end{minipage}
	\hfill
	\begin{minipage}{5cm}
...
\begin{frame}
    ...
    \vspace{0.5cm} \hspace{0.1cm} \includegraphics[scale=0.45]{img/xunit} \hspace{0.7cm}
    \includegraphics[scale=0.6]{img/moq}
    \hspace{0.2cm} \includegraphics[scale=0.3]{img/git}~\\
...
\begin{frame}
	...
	\begin{tabular}{@{\extracolsep{\fill}} |l|c|}
		...
		\hline
		\textbf{Gesamt} & \textbf{90,79} \\ \hline
	\end{tabular}
	~\\
	Zeilen eigener Programmcode insgesamt: ca. 7300 ~\\ % actual 7318   
...
\begin{frame}
    ...
    \begin{itemize}
       ...
       \begin{itemize}
       		\item<+-> löst aber nicht alle Probleme
       		\item<+-> kann auch Probleme mit sich bringen
       	\end{itemize}
